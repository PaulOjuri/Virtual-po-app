  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 relative">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Welcome to AgileOS</h1>
        <p className="text-gray-600 mt-2">Sign in to your personalized SAFe platform</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-gray-500 text-sm">Contact admin for access</p>
      </div>
    </div>
  );
};