-- Add missing stakeholders table
...
-- Create trigger for stakeholders
...
-- Fix RLS policies that might be causing 406/403 errors by making them more permissive
...
-- Also fix stakeholders policies
